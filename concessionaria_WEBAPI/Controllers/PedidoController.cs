...
public class PedidoController : ControllerBase
{
    ...
    [HttpGet("/Pedido/Listar/Finalizados")]
    public async Task<ActionResult<List<PedidoModel>>> BuscarPedidosFinalizados()
    {
        return await _pedidoRepositorio.BuscarPedidosFinalizados();
    }
